...
library(dplyr)
blood_regression_test_wt_lifespan <- function(data, metadata) {
...
blood_regression_test_wt_lifespan_result <- blood_regression_test_wt_lifespan(data = blood_metadata_wt_life_span_betas,
                                                 metadata = blood_metadata_wt_life_span)

saveRDS(blood_regression_test_wt_lifespan_result, file = "~/Phd_data/outputs/blood_regression_test_wt_lifespan_result.rds")
