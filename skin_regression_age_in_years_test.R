...
######### This script was written to determine the linear regression between age (in years)
#########  and beta values of DNA methylation level in Skin tissues


######################## LINEAR REGRESSION IN DNA METHYLATION SKIN SAMPLES ONLY ##########################################
...
skin_regression_test_wt_lifespan <- function(data, metadata) {
...
skin_regression_wt_lifespan_result <- skin_regression_test_wt_lifespan(data = skin_metadata_wt_life_span_betas,
                                                                       metadata = skin_metadata_wt_life_span)

saveRDS(skin_regression_wt_lifespan_result, file = "~/Phd_data/outputs/skin_regression_age_in_years.rds")
