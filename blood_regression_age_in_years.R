...
#########  and beta values of DNA methylation level in Blood tissues
...
blood_regression_age_in_years <- function(data, metadata) {
...
blood_regression_age_in_years_result <- blood_regression_age_in_years (data = blood_metadata_wt_life_span_betas,
                                                                       metadata = blood_metadata_wt_life_span)

saveRDS(blood_regression_age_in_years_result, file = "~/Phd_data/outputs/blood_regression_age_in_years.rds")
