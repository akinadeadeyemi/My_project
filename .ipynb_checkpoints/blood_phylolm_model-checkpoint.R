...
blood_regression_phylogenetic_simple <- function(data, metadata, phy_tree) {
...
blood_phylolm_result <- blood_regression_phylogenetic_simple(data = blood_metadata_wt_life_span_betas,
                                                      metadata = blood_metadata_wt_life_span,
                                                      phy_tree = blood_species_tree)
saveRDS(blood_phylolm_result, file = "~/Phd_data/outputs/blood_phylolm_result.rds")
