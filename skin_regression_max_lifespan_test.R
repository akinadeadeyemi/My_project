...
library(dplyr)
skin_regression_test_wt_max_lifespan <- function(data, metadata) {
...
skin_regression_wt_max_lifespan_result <- skin_regression_test_wt_max_lifespan(data = skin_metadata_wt_life_span_betas,
                                                                       metadata = skin_metadata_wt_life_span)

saveRDS(skin_regression_wt_max_lifespan_result, file = "~/Phd_data/outputs/skin_regression_wt_max_lifespan_result.rds")
