#!/bin/bash
#SBATCH --job-name=skin_sample_32_correlation_job
#SBATCH --output=skin_sample_32_correlation_job.out
#SBATCH --error=skin_sample_32_correlation_job.err
#SBATCH --mem=60gb
...
Rscript skin_sample_32_correlation.R
