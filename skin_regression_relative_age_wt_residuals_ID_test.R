...
skin_regression_stream_residuals <- function(data, metadata, output_file = "skin_regression_relative_age_wt_residuals_ID.csv") {
  library(data.table)
...
skin_regression_stream_residuals(
  ...
  output_file = "~/Phd_data/outputs/skin_regression_relative_age_wt_residuals_ID.csv"
)
