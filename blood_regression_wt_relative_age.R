...
library(dplyr)
blood_regression_test_wt_relative_age <- function(data, metadata) {
...
blood_regression_test_wt_relative_age_result <- blood_regression_test_wt_relative_age(data = blood_metadata_wt_life_span_betas,
                                                                       metadata = blood_metadata_wt_life_span)

saveRDS(blood_regression_test_wt_relative_age_result, file = "~/Phd_data/outputs/blood_regression_wt_relative_age.rds")
